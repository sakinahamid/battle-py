...
class TestTask5(unittest.TestCase):
    ...
    def test__conduct_combat(self):
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
        try:
            self.assertEqual(str(t2.force), "Archer's life = 1 and experience = 1", msg="Army 2 wrong for Fairer 1,0,0 0,1,0")
        except AssertionError as e:
            self.verificationErrors.append(str(e))

        # your tests for __conduct_combat go here
        # Test if combat is conducted correctly and if it returns
        # appropriate result for empty p1 army and empty p2 army
        # Assumes __assign_army is working correctly
        t1._Army__assign_army("", 0, 0, 0, formation)
        t2._Army__assign_army("", 0, 0, 0, formation)
        try:
            self.assertFalse(battle._Battle__conduct_combat(t1, t2, formation) != 0, "Gladiatorial 0,0,0 0,0,0 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        try:
        ...
        try:
            ...
            # Test if combat is conducted correctly and if it returns
            # appropriate result for all Soldier, Archer and Cavalry p1 army and all Soldier, Archer and Cavalry p2 army
            # Assumes __assign_army is working correctly
            t1._Army__assign_army("", 1, 1, 1, formation)
            t2._Army__assign_army("", 1, 1, 1, formation)
            try:
                self.assertTrue(battle._Battle__conduct_combat(t1, t2, formation) == 0,
                                 "Gladiatorial 0,0,0 0,0,0 failed")
            except AssertionError as e:
                self.verificationErrors.append(str(e))
            try:
